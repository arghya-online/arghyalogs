...
export default function BlogContent() {
    return (
        <article className="max-w-none mx-auto sm:px-6 text-text-primary">
            ...
            <p className="mb-6 text-base sm:text-lg leading-relaxed text-text-secondary">DNS exists to handle this quietly. It takes the name you give and finds the location behind it. Once that mapping is clear, the rest of the internet stack can do its job. Until then, everything waits.</p>
            <h3 className="mt-12 mb-4 text-xl sm:text-2xl font-bold tracking-tight text-text-primary">
