...
const achievements = [
  {
    ...
    description:
      "Won 1st place at the Annual State Robotics Hackathon by building an autonomous sorting arm in 24 hours.",
  },
  {
    title: "Open Source Contributor",
    description:
      "Merged PRs into major React libraries improving component rendering performance.",
  },
  {
    title: "Freelance Excellence",
    description:
      "Successfully shipped over 10 full-stack applications for international clients with 5-star ratings.",
  },
];
  ...
  return (
    <div className="space-y-20 pb-20">
      <Helmet>
        ...
        <meta
          name="description"
          content="About me, my skills, and achievements."
        />
      </Helmet>
      ...
      >
        <motion.h1
          variants={fadeInUp}
          className="text-4xl font-bold tracking-tight mb-8 flex items-center gap-3"
        >
        ...
        <motion.div
          variants={fadeInUp}
          className="space-y-2 text-lg text-text-secondary leading-relaxed max-w-3xl"
        >
          <p>
            I’m Arghya, an engineer from Kolkata. I build websites and
            applications, focusing on things that are actually useful and work
            well. I mostly work with React, Node.js, and whatever database fits
            the problem, and I try to keep everything simple and clean.
          </p>
          <br />
          <p>
            Outside of coding, I build robots and do some CAD modeling and 3D
            printing as a hobby. I also make YouTube videos, just sharing what I
            learn. Still figuring things out.
          </p>
        </motion.div>
      </motion.section>
      ...
      >
        <motion.h2
          variants={fadeInUp}
          className="text-3xl font-bold mb-10 flex items-center gap-3 text-text-primary"
        >
      ...
      >
        <motion.h2
          variants={fadeInUp}
          className="text-xl font-bold mb-4 flex items-center gap-2 text-text-primary"
        >
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="space-y-6">
          {[
            ...
            <div
              key={i}
              className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-1"
            >
              <div>
              ...
              <span className="text-xs font-mono text-text-secondary sm:text-right">
                {exp.period}
              </span>
            </div>
          ))}
